...
@task(bind=True)
def add_students_to_database_two(self):
	db = client.students
	students_temp = db.students
	friends_list = db.friends_list
	
	first_name_var = "karl"
	last_name_var = "shits his pants"
	email_stuff = "mayShitHis_@gmail.com"
	school_name= "magicSchoolBus"
...
def search_for_student(name):
    ...
    #username = name
    username = "pleasework_@gmail.com"
    # Search this person
    first_name = "punk"
    last_name = "bitch"
    # find out who i am
